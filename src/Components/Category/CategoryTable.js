...
export default function CategoryTable(){
    const [loading,collection,setCollection,deleteData,editData]=useOutletContext();
    return(
        <>
        <h1>Category<span style={{float:'right'}}><Link to="/panel/category/new" type="primary">Add New</Link></span></h1>
